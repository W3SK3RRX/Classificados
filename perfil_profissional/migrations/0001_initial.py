# Generated by Django 5.1.3 on 2025-01-15 00:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(blank=True, help_text='Obrigatório para profissionais liberais.', max_length=14, null=True, unique=True, validators=[perfil_profissional.models.PerfilProfissional.validate_cpf])),
                ('cnpj', models.CharField(blank=True, help_text='Obrigatório para empresas.', max_length=18, null=True, unique=True, validators=[perfil_profissional.models.PerfilProfissional.validate_cnpj])),
